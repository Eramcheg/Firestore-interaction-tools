...
directory_path = "G:\\FIles\\OliverWeber\\SpringCatalog2025"
...
for filename in os.listdir(directory_path):
    if filename.endswith(".jpg") or filename.endswith(".png") :
        ...
        upload_file(file_path, "SpringCollection2025/" + filename, filename[:-4])
...
# Saving data
with open('../../static_files/SpringCollection2025.txt', 'w') as file:
