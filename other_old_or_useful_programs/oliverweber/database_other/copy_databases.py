...
source_cred = credentials.Certificate("G:\\FIles\\firebase\\key4_Terminal.json")
source_app = firebase_admin.initialize_app(source_cred,name='source_app')

# Initialize the destination app
destination_cred = credentials.Certificate('G:\\FIles\\firebase\\terminaltests_key.json')
